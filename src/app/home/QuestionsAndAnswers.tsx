...
const QAS = [
    ...
    answer: (
      <>
        ...
        <p>
          ...
          Vitamin Resume & Cover saves time and prevents formatting mistakes by
  ...
  {
    question:
      "Q2. What uniquely sets Vitamin Resume & Cover apart from other resume builders and templates?",
    answer: (
      <>
        <p>
          Other than Vitamin Resume & Cover, there are some great free resume builders out
          there, e.g. <Link href="https://rxresu.me/">Reactive Resume</Link>,{" "}
          <Link href="https://flowcv.com/">FlowCV</Link>. However, Vitamin Resume & Cover
          stands out with 2 distinctive features:
        </p>{" "}
        <p>
          <span className="font-semibold">
            1. Vitamin Resume & Cover is designed specifically for the U.S. job market and
            best practices.
          </span>
          <br />
          Unlike other resume builders that target a global audience and offer
          many customization options, Vitamin Resume & Cover intentionally only offers
          ...
          like references. Additionally, Vitamin Resume & Cover only offers a top down
          single column resume design as opposed to two column design, because
          single column design works best for AST. <br />{" "}
        </p>
        <p>
          <span className="font-semibold">
            2. Vitamin Resume & Cover is super privacy focus.
          </span>{" "}
          <br />
          While other resume builders may require email sign up and store user
          data in their databases, Vitamin Resume & Cover believes that resume data should
          remain private and accessible only on user’s local machine. Therefore,
          Vitamin Resume & Cover doesn’t require sign up to use the app, and all inputted
  ...
  {
    question: "Q3. Who created Vitamin Resume & Cover and why?",
    answer: (
      <p>
        Vitamin Resume & Cover was created by{" "}
        ...
        that led to Vitamin Resume & Cover, where we integrated best practices and our
        knowledge into this resume builder. Our hope is that Vitamin Resume & Cover can help
  ...
  {
    question: "Q4. How can I support Vitamin Resume & Cover?",
    answer: (
      <>
        <p>
          The best way to support Vitamin Resume & Cover is to share your thoughts and
        ...
        <p>
          Another great way to support Vitamin Resume & Cover is by spreading the words.
