...
const FEATURES = [
  {
    src: featureFreeSrc,
    title: "Free Forever",
    text: "Vitamin Resume & Cover is created with the belief that everyone should have free and easy access to a modern professional resume design",
  },
  {
    src: featureUSSrc,
    title: "U.S. Best Practices",
    text: "Vitamin Resume & Cover has built-in best practices for the U.S. job market and works well with top ATS platforms such as Greenhouse and Lever",
  },
  {
    src: featurePrivacySrc,
    title: "Privacy Focus",
    text: "Vitamin Resume & Cover stores data locally in your browser so only you have access to your data and with complete control",
  },
  {
    ...
    text: (
      <>
        Vitamin Resume & Cover is an open-source project, and its source code can be viewed
        by anyone on its{" "}
